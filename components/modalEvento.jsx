...
export default function ModalAsesoria(props){
       ...
       isOpen &&(        
            ...
            <div className="bg-contrast-slateGray100  bg-opacity-30 w-[40%] rouded flex flex-col 
                ...
                <div className="flex flex-col text-center p-2 ">
                  <Header5 text="La asesoría para un evento contemplan tus" textColor="text-primary-brownPod950"/>
                  
                  <Header5 text="metas y más para transformar en conjunto" textColor="text-primary-brownPod950" />
                  <Header5 text="tu presencia e imagen para tu evento." textColor="text-primary-brownPod950" /> 
                  <Header5 text="Reflejaras confianza y autenticidad " textColor="text-primary-brownPod950" />
                  <Header5 text="ante todos. " textColor="text-primary-brownPod950" />           
