       ...
       isOpen &&(        
            ...
            <div className="bg-contrast-slateGray100 bg-opacity-30 w-[40%] rouded flex flex-col 
                ...
                <div className="flex flex-col text-center p-2 ">
                  <Header5 text="La asesoría integral incluye:" textColor="text-primary-brownPod950"/>
                  <Header5 text="Asesoría de imagen + Orden de guardarropa +" textColor="text-primary-brownPod950" />
                  <Header5 text="Personal shopper virtual" textColor="text-primary-brownPod950" /> 
                  <Header5 text="¡El servicio más completo!" textColor="text-primary-brownPod950" />           
